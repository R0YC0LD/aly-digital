...
async function fetchText(url) {
  const res = await fetch(url, {
    headers: {
      "user-agent": "Mozilla/5.0 (compatible; AlyTrackBuilder/1.0)",
...
function parseTrackPage(html, trackId) {
  ...
  // Primary if first artist mention after "by" is ALY / target id appears before other artists near title
