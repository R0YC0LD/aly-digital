...
async function main() {
  ...
  if (String(raw).includes("0FUsrstJwmg4WVHQMTYuUA") || String(raw).toLowerCase().includes("şehinşah") || String(raw).toLowerCase().includes("sehinsah")) {
    errors.push("catalog still contains Şehinşah identity");
  }
